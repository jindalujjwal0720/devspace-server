...
<div class="container" style="box-sizing: border-box;width: 100%;height: 100%;max-width: 600px;margin: 0 auto;font-family: Arial, Helvetica, sans-serif;">
  ...
  <div class="content" style="box-sizing: border-box;width: 100%;padding: 1rem;font-size: 1rem;font-weight: 400;line-height: 1.4;letter-spacing: 0.03rem;background-color: #fafafa;">
      Devspace has received a request to verify your email address. Please use the following code to verify your email
      address.
      <div class="code" style="box-sizing: border-box;width: 100%;padding: 1rem 2rem;margin: 1.5rem 0;border-radius: 4px;background-color: #fff;color: #000;font-size: 1.5rem;font-weight: 500;letter-spacing: 1rem;text-align: center;">
          ${otp}
      </div>
